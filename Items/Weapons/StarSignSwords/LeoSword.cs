...
namespace SwordsPlus.Items.Weapons.StarSignSwords
{
    public class LeoSword : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Leo"); // By default, capitalization in classnames will add spaces to the display name.
            Tooltip.SetDefault("Produces Homing Stars When Swung"); // Devs can change this at will to test features before commiting code to new classes
        }
